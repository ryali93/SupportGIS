...
CCPP = r'C:\Users\ryali93\Documents\ArcGIS\Default.gdb\TB_CCPP_Project' # Cambiar por la ruta de ccpp
CAPITAL = r'E:\SupportGIS\ABARJA\capitales.shp' # Cambiar por la ruta de capitales
PUNTOS_TMP = r'E:\SupportGIS\ABARJA\puntos_tmp.shp' # Cambiar por cualquier ruta
SALIDA = r'E:\SupportGIS\ABARJA\salida.shp' # Cambiar por shp de salida

CODIGO = 'CODPROV' # CAMBIAR
WEIGHT = 'VIV_CCPP' # CAMBIAR
